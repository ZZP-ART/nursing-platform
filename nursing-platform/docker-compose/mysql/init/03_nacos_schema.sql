...
SET @content = 'nursing:
  ...
  sms:
    ...
    expire-seconds: 300
    idempotent-retention-hours: 24
    idempotent-cleanup-fixed-delay-millis: 3600000
    idempotent-cleanup-batch-size: 500
    outbox-fixed-delay-millis: 1000
    outbox-batch-size: 20
    outbox-processing-timeout-seconds: 120
  file:
    upload-dir: uploads
