...
| `CaregiverTask` | `assignmentId:string,orderId:string,orderNo:string,merchantId:string,caregiverUserId:string,assignmentStatus:number,orderStatus:number,serviceItemId:string,serviceItemName:string,specName:string,serviceDate:string,serviceTimeSlot:string,receiverName:string,receiverPhone:string,addressDetail:string,remark:string|null,totalAmount:number,createTime:string,serviceRecords:ServiceAction[],availableActions:string[]` |
| `ServiceAction` | `action:string,remark:string|null,createTime:string` |
| `MerchantOrder` | `orderId:string,orderNo:string,orderStatus:number,assignmentStatus:number|null,serviceItemName:string,specName:string,totalAmount:number,serviceDate:string,serviceTimeSlot:string,receiverName:string,receiverPhone:string,addressDetail:string,currentAssignment:Assignment|null,assignments:Assignment[],serviceRecords:ServiceAction[],createTime:string` |
| `MerchantDashboard` | `merchantId:string,merchantName:string,waitingDispatch:number,waitingAccept:number,todayServices:number,inService:number,totalOrders:number,completed:number,monthRevenue:number,exceptionCount:number` |
| `CaregiverCandidate` | `caregiverUserId:string,caregiverId:string,name:string,rating:number,completedOrders:number,distanceKm:number|null,dailyTaskCount:number,maxDailyOrders:number,serviceAreas:string[],skills:string[],eligible:boolean,conflictReasons:string[]` |
...
| `GET /api/v1/caregivers/tasks` | CAREGIVER | 无 | `CaregiverTask[]` | `403/1004` |
| `GET /api/v1/caregivers/tasks/{orderId}` | CAREGIVER | P:`orderId:string!` | `CaregiverTask` | `403/1004` |
| `GET /api/v1/merchants/dashboard` | MERCHANT_MEMBER | 无 | `MerchantDashboard` | `403/1004` |
| `GET /api/v1/merchants/orders` | MERCHANT_MEMBER | Q:`status:number?` | `MerchantOrder[]` | `403/1004` |
| `GET /api/v1/merchants/orders/{orderId}` | MERCHANT_MEMBER | P:`orderId:string!` | `MerchantOrder` | `403/1004` |
| `GET /api/v1/merchants/orders/{orderId}/assignments` | MERCHANT_MEMBER | P:`orderId:string!` | `Assignment[]` | `403/1004` |
| `GET /api/v1/merchants/orders/{orderId}/candidates` | MERCHANT_MEMBER | P:`orderId:string!` | `CaregiverCandidate[]` | `403/1004` |
...
| `GET /internal/v1/orders/merchant/{merchantId}` | 运营服务 | P:`merchantId:string!`; Q:`status:number?` | `OrderDTO[]` |
